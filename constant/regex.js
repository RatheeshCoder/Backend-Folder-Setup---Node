...
export const NAME = /^[A-Z][a-z]+(?: [A-Z][a-z]+)*$/;
export const COLLEGENAME = /^[A-Za-z]+(?: [A-Za-z]+)*$/;
...
export const DATE_ISOSTRING =
  /(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))/;
export const IS_JSON = /^[\s]*\{[\s\S]*\}[\s]*$/;
export const URL_VALIDATOR =
  /^(https?:\/\/)?(?:www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_\+.~#?&\/=]*)$/;
export const IP_REGEX =
  /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\/\d{1,2}|(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;
...
export const NOSPACE = /^[a-zA-Z0-9]+$/;
export const COUNTRY = /^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$/;
export const PAN = /^[A-Z]{5}[0-9]{4}[A-Z]$/;
export const TAN = /^[A-Z]{4}[0-9]{5}[A-Z]$/;
export const ACCOUNTNUMBER = /^[0-9]{1,50}$/;
